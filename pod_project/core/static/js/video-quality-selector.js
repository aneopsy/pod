    ...
    _V_.plugin('resolutionSelector', function (options) {
        ...
        var player = this,
            ...
            settings = _V_.util.mergeOptions({
                ...
                force_types: {'video/webm', 'audio/wav'}	// (array) List of media types. If passed, we need to have source for each type in each resolution or that resolution will not be an option
            }, options || {}),
